...
class LocationMgrImpl implements LocationFinder {
	 ...
	 * 
	 * @see
	 * ar.mgr.location.LocationFinder#findLocation(android.content.Context
	 * )
	 */
	public void findLocation() {
		...
		hardFix.setLatitude(37.62929);
		hardFix.setLongitude(127.081524);
	 ...
	 * 
	 * @see
	 * ar.mgr.location.LocationFinder#locationCallback(android.content
	 * .Context)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ar.mgr.location.LocationFinder#getCurrentLocation()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ar.mgr.location.LocationFinder#getLocationAtLastDownload()
	 */
	 ...
	 * 
	 * @see
	 * ar.mgr.location.LocationFinder#setLocationAtLastDownload(android
	 * .location.Location)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ar.mgr.location.LocationFinder#getGeomagneticField()
	 */
